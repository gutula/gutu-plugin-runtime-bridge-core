...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/runtime-bridge-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-runtime-bridge-core:");
...
console.log("Documentation check passed for gutu-plugin-runtime-bridge-core.");
